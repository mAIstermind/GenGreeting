...
export const promptTemplates: PromptTemplate[] = [
  ...
  },
  {
    ...
    template: `An exaggerated, cartoon-style illustration of a modern office meeting. All audience members are engrossed in their glowing smartphones, completely ignoring the presenter. The presenter holds up a large sign where the text "Did this get your attention, \${firstName}?" is written in bold, eye-catching, and clearly readable letters.`,
  ...
  },
  {
    ...
    template: `A photorealistic image of a sleek, modern office waste paper bin. Inside, nestled amongst crumpled papers, is a gleaming, 24-karat gold bar catching the light. At the bottom of the image, the text "Did I get your attention, \${firstName}?" is elegantly written in a clean, sans-serif font, clearly visible and legible.`,
  ...
  },
  {
    ...
    template: `A top-down view of a cluttered but stylish office desk. Among the papers, pens, and a coffee mug, lies a clearly visible winning lottery ticket for a massive jackpot. The text "Some opportunities are easy to miss. Did this get your attention, \${firstName}?" is artfully integrated into the scene in a way that is clear and easy to read.`,
  ...
  },
  {
    ...
    template: `A surreal, high-detail illustration of a sophisticated corporate boardroom. In the middle of the room, standing calmly, is a well-groomed llama wearing a business tie. On a whiteboard in the background, the text "Probably not what you were expecting. Did I get your attention, \${firstName}?" is clearly legible.`,
  ...
  },
  {
    ...
    template: `A minimalist scene showing hundreds of plain, white paper airplanes all flying in one direction. One single, brightly colored red paper airplane is flying in the opposite direction, creating a strong visual contrast. In the empty space, the text "It's tough to stand out. Did this get your attention, \${firstName}?" is clearly written and easy to read.`,
  ...
  },
  {
    ...
    template: `A vibrant pop-art style illustration celebrating a birthday. The background is an explosion of colorful confetti and graphic shapes. The text "Happy Birthday, \${firstName}!" takes center stage in bold, playful, and clearly legible lettering. The mood is energetic and fun.`,
  ...
  },
  {
    ...
    template: `A cozy, rustic holiday greeting card. The scene is a warm fireplace with stockings hung. The border is decorated with hand-drawn style holly and pinecones. The text "Happy Holidays, \${firstName}!" is written in a friendly, handwritten, and clearly legible font.`,
  ...
  },
  {
    ...
    template: `An elegant and professional image to celebrate a business anniversary. The design features clean, abstract lines with a sophisticated color palette of navy blue, white, and a touch of gold foil. The text "Happy Anniversary, \${firstName}!" is written in a modern, sans-serif, and clearly legible font.`,
  ...
  },
  {
    ...
    template: `A modern, motivational illustration for a career milestone. It depicts a stylized rocket launching towards the stars, symbolizing a new journey and success. The text "Congratulations on the new role, \${firstName}!" is placed in a clean, professional, and clearly legible font.`,
  ...
  },
  {
    ...
    template: `An artistic image of a beautiful bouquet of watercolor flowers. The entire image is enclosed within a delicate, elegant floral frame. In the center, the text "A note for you, \${firstName}!" is elegantly written and clearly legible.`,
  ...
  },
  {
    ...
    template: `A festive and vibrant scene with glowing sparklers creating beautiful light trails against a twilight sky. The text "Time to celebrate, \${firstName}!" is written in a fun, celebratory, and clearly legible font. The mood is exciting and happy.`,
