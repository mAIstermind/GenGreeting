        ...
        <div className="flex flex-col sm:flex-row justify-between items-center mb-8 gap-4">
            ...
            <div className="flex items-stretch gap-2 flex-col sm:flex-row w-full sm:w-auto">
                <div className="flex flex-col items-center gap-2">
                    <button onClick={onDownloadAll} disabled={isBranding || !isOnline} className="w-full inline-flex items-center justify-center gap-2 px-5 py-3 border border-transparent text-base font-medium rounded-md shadow-sm text-white bg-blue-600 hover:bg-blue-700 disabled:bg-gray-500">
                    ...
                    <p className="text-xs text-green-400 flex items-center justify-center gap-1.5">
                        ...
                        Your custom branding will be applied (1 credit per card).
                    </p>
                    )}
                </div>
