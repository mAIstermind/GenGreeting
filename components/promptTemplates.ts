...
export const promptTemplates: PromptTemplate[] = [
  {
    ...
    description: 'A stylish, modern avatar featuring the first initial of a person\'s name. Great for generating personalized profile pictures in bulk.',
  ...
  {
    id: 're_engagement_robot',
    name: `We've Missed You`,
    description: `A warm, inviting image of a friendly, slightly sad-looking robot holding a sign. Perfect for re-engaging with contacts you haven't spoken to in a while.`,
    template: `A charming, heartwarming illustration of a friendly, slightly lonely-looking robot holding a welcome sign. The sign MUST have the text "We've missed you, \${firstName}!" written in a friendly, handwritten font. The robot is surrounded by soft, warm lighting. The overall mood is gentle, inviting, and designed to re-engage in a non-demanding way.`,
    thumbnail: `data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'%3e%3crect width='100' height='100' fill='%231f2937'/%3e%3crect x='40' y='50' width='20' height='30' fill='%239ca3af' rx='5'/%3e%3ccircle cx='50' cy='40' r='15' fill='%239ca3af'/%3e%3ccircle cx='45' cy='38' r='3' fill='white'/%3e%3ccircle cx='55' cy='38' r='3' fill='white'/%3e%3cpath d='M45 45 q 5 5 10 0' stroke='white' fill='none' stroke-width='1'/%3e%3crect x='25' y='55' width='50' height='20' fill='white' rx='3'/%3e%3ctext x='50' y='69' font-size='8' fill='black' text-anchor='middle' font-family='Arial'%3eMiss you!%3c/text%3e%3c/svg%3e`,
  },
  {
    id: 'reconnect_appointment',
    name: 'Time to Reconnect',
    description: `A professional and clean image of a calendar icon with a coffee cup, symbolizing a friendly meeting or appointment.`,
    template: `A clean, professional, and inviting graphic for an appointment. It features a modern, stylized calendar icon alongside an aromatic cup of coffee, symbolizing a friendly chat. Below the icons, the text "Time to reconnect, \${firstName}?" MUST be written in an elegant, clear, and welcoming font. The background is a clean, light gray, giving it a premium feel.`,
    thumbnail: `data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'%3e%3crect width='100' height='100' fill='%231f2937'/%3e%3crect x='25' y='30' width='30' height='30' fill='white' rx='3'/%3e%3crect x='25' y='30' width='30' height='8' fill='%23ef4444' rx='3'/%3e%3cpath d='M60 50 C 75 50, 75 70, 60 70 L 60 50' fill='%239ca3af'/%3e%3cpath d='M60 50 h 15 v 20 h -15 Z' fill='%23d1d5db'/%3e%3c/svg%3e`,
  },
  {
    id: 'special_offer',
    name: 'Just For You',
    description: 'A visually striking image of a stylized, elegant gift box. Perfect for pairing with a special offer to re-engage your list.',
    template: `A sophisticated and minimalist image of an elegant, closed gift box with a single, beautiful ribbon. The box is subtly glowing. The text "A special something for you, \${firstName}" MUST be written below in a premium, serif font. The background should be dark and clean to make the gift box pop.`,
    thumbnail: `data:image/svg+xml,%3csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'%3e%3crect width='100' height='100' fill='%231f2937'/%3e%3crect x='30' y='50' width='40' height='30' fill='%23a78bfa'/%3e%3crect x='30' y='45' width='40' height='5' fill='%238b5cf6'/%3e%3crect x='48' y='25' width='4' height='20' fill='%238b5cf6'/%3e%3cpath d='M45 25 C 45 15, 55 15, 55 25' fill='%238b5cf6'/%3e%3c/svg%3e`,
  },
  {
    ...
    template: `An exaggerated, cartoon-style illustration of a modern office meeting. All audience members are engrossed in their glowing smartphones, completely ignoring the presenter. The presenter holds up a large sign. You MUST write the following text on the sign in bold, eye-catching letters: "Did this get your attention, \${firstName}?". The text must be clear and readable.`,
  ...
  },
  {
    ...
    template: `A photorealistic image of a sleek, modern office waste paper bin. Inside, nestled amongst crumpled papers, is a gleaming, 24-karat gold bar catching the light. The final image MUST have the text "Did I get your attention, \${firstName}?" elegantly written in a clean, sans-serif font at the bottom, clearly visible and legible.`,
  ...
  },
  {
    ...
    template: `A top-down view of a cluttered but stylish office desk. Among the papers, pens, and a coffee mug, lies a clearly visible winning lottery ticket for a massive jackpot. The final image MUST have the text "Some opportunities are easy to miss. Did this get your attention, \${firstName}?" artfully integrated into the scene in a way that is clear and easy to read.`,
  ...
  },
  {
    ...
    template: `A surreal, high-detail illustration of a sophisticated corporate boardroom. In the middle of the room, standing calmly, is a well-groomed llama wearing a business tie. You MUST write the following text on a whiteboard in the background: "Probably not what you were expecting. Did I get your attention, \${firstName}?". The text must be clearly legible.`,
  ...
  },
  {
    ...
    template: `A minimalist scene showing hundreds of plain, white paper airplanes all flying in one direction. One single, brightly colored red paper airplane is flying in the opposite direction, creating a strong visual contrast. You MUST place the following text in the empty space, ensuring it is clear and easy to read: "It's tough to stand out. Did this get your attention, \${firstName}?".`,
  ...
  },
  {
    ...
    template: `A stylish and professional birthday card illustration for an office setting. It features subtle, festive elements like balloons in corporate colors (blue, gray, white) and a cupcake with a single candle on a clean desk. The final image MUST have the text 'Happy Birthday, \${firstName}!' written in a modern, friendly, and clearly legible font. The overall mood is celebratory but still appropriate for the workplace.`,
  ...
  },
  {
    ...
    template: `An elegant and professional 'Thank You' card design. It features a warm, abstract background with sophisticated typography. The final image MUST have the text 'Thank you for your partnership, \${firstName}!' prominently displayed in a beautiful, legible script font. The design should convey gratitude and appreciation in a business context.`,
  ...
  },
  {
    ...
    template: `A vibrant pop-art style illustration celebrating a birthday. The background is an explosion of colorful confetti and graphic shapes. The final image MUST have, in bold, playful, and clearly legible lettering, the text "Happy Birthday, \${firstName}!" taking center stage. The mood is energetic and fun.`,
  ...
  },
  {
    ...
    template: `A cozy, rustic holiday greeting card. The scene is a warm fireplace with stockings hung. The border is decorated with hand-drawn style holly and pinecones. The final image MUST have the text "Happy Holidays, \${firstName}!" written in a friendly, handwritten, and clearly legible font.`,
  ...
  },
  {
    ...
    template: `An elegant and professional image to celebrate a business anniversary. The design features clean, abstract lines with a sophisticated color palette of navy blue, white, and a touch of gold foil. The final image MUST have the text "Happy Anniversary, \${firstName}!" written in a modern, sans-serif, and clearly legible font.`,
  ...
  },
  {
    ...
    template: `A modern, motivational illustration for a career milestone. It depicts a stylized rocket launching towards the stars, symbolizing a new journey and success. The final image MUST have the text "Congratulations on the new role, \${firstName}!" placed in a clean, professional, and clearly legible font.`,
  ...
  },
  {
    ...
    template: `An artistic image of a beautiful bouquet of watercolor flowers. The entire image is enclosed within a delicate, elegant floral frame. In the center, you MUST elegantly write the text "A note for you, \${firstName}!". The text must be clearly legible.`,
  ...
  },
  {
    ...
    template: `A festive and vibrant scene with glowing sparklers creating beautiful light trails against a twilight sky. You MUST write the text "Time to celebrate, \${firstName}!" in a fun, celebratory, and clearly legible font. The mood is exciting and happy.`,
