...
export const GreetingCard: React.FC<GreetingCardProps> = ({ card, onEdit }) => {
    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden transition-transform transform hover:scale-105 duration-300 flex flex-col">
      ...
      <div className="p-4 flex flex-col flex-grow">
        <div className="flex-grow">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 truncate" title={card.email}>{card.email}</p>
        </div>
        <button
